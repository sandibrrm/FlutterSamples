// src/lib.rs
/*
 * Core library for FlutterSamples
 */
...
#[derive(Debug)]
pub struct FlutterSamplesProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FlutterSamplesProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FlutterSamples processing");
    
    let mut processor = FlutterSamplesProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FlutterSamplesProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FlutterSamplesProcessor::new(false);
